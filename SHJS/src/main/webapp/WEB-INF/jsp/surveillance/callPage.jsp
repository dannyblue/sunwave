			...
			jQuery(document)
					.ready(
							function() {
				                ...
				                var cols = [
				                    { title:'告警时间', name:'recordDate' ,width:100, align:'center', sortable: true,sortName:'record_date', type: 'number',renderer: function(val){
				                    ...
				                    },{ title:'对方号码', name:'targNum' ,width:100, align:'center', sortable: true,sortName:'targNum', type: 'number'
				                    	...
				                    	default :
				                        	...
				                        	return  '<button href="#confirmation" data-toggle="modal" data-op="manage"  class="btn green">处理</button>&nbsp&nbsp<button data-op="delete"  class="btn red">删除</button>';
				                    }}
				                ];
								...
								var mmg = $('.mmg').mmGrid({
									height : 450,
									cols : cols,
									url : 'surveillance.call.getList.do',
									method : 'post',
									remoteSort : true,
									root : 'data',
										...
										.on(
												...
												function(e, item, rowIndex,
													...
													//修改
														...
														$
																.ajax({
																	url : 'surveillance.call.remove.do',
																	type : 'post',
																	dataType : 'json',
																	data:{ids:item.callId},
																	success : function(
																			v) {
																		mmg
																				.removeRow(rowIndex);
